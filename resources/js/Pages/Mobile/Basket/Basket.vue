              ...
              <v-col class="mx-auto my-auto px-0" >
                <v-layout align-center>
                  <v-row class="mx-auto" align="center" justify="center">
                    ...
                    <v-col cols="12" align="center" class="py-1">
                      <v-btn fab elevation="0" x-small dark color="red" @click="[product.quantity > 0 ? product.quantity-- : '']"> <v-icon >mdi-minus</v-icon></v-btn>
                    </v-col>
                  </v-row>
                </v-layout>
              </v-col >
              ...
              <v-card-text ref="visa">
               <v-form>
                ...
                <v-row class="mx-2 my-1">
                  <v-btn dark color="primary"> Pay </v-btn>
                  <v-spacer></v-spacer>
                  <span class="text-h5">{{ totalPrice }} manat </span>
                </v-row>
              </v-form> 
