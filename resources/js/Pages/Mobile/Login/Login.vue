  ...
  <MobileLayout>
          ...
          <v-container fluid>
            <v-row>
              <v-col cols="12" sm="6" md="6">
                <v-text-field :label="$t('Email')" v-model="data.email" required></v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="6">
    ...
    <v-layout v-if="register">
      <v-card>
        ...
        <v-card-text>
          <v-container fluid>
            <v-row>
              ...
              <v-col cols="12" sm="6" md="6">
                <v-text-field :label="$t('password') + '*'" type="password" v-model="data.password" required>
                </v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="6">
        ...
        <v-card-actions>
          <v-btn color="blue darken-1" text @click="login = true, register = false">{{ $t('Already has profile') }}
          </v-btn>
          <v-spacer></v-spacer>
